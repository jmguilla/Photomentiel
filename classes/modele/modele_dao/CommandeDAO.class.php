...
class CommandeDAO extends DAO{
	...
	public function buildCommandeFromRow($row){
		...
		$id = htmlspecialchars($row->offsetGet("commandeID"));
		$date = htmlspecialchars($row->offsetGet("date"));
		$dp = htmlspecialchars($row->offsetGet("datePaiement"));
		$idUtilisateur = htmlspecialchars($row->offsetGet("id_utilisateur"));
		$s = htmlspecialchars($row->offsetGet("etat"));
		$fdp = htmlspecialchars($row->offsetGet("fdp"));
		$numero = htmlspecialchars($row->offsetGet("numero"));
