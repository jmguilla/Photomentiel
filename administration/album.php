	...
	foreach($assocs as $assoc){
		...
		if ($album->getTransfert()){
			...
			if ($uploadObj){
				...
				$debut = $uploadObj->getDebut();
				$transferStr = "Transfert en cours ($uploadedPics/$toUploadPics - $percentPics%) commence a $debut";
			} else {
