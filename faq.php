...
<div id="full_content_mid">
	...
	<div id="faqc">
		...
		<div class="answer">
		  <span class="start"></span>Rendez vous sur la <a href="/index.php">page d'accueil</a> et saississez le code inscrit en bas de la carte qui vous a été remise. Vous accèdez alors aux photographies prises lors de l'événement auquel vous avez participer, faites votre sélection et laissez vous guider jusqu'à la phase de paiement. Vous recevrez ensuite les photographies sélectionnées par les services postaux.
		</div>
		<div class="question"><a name="11"></a>Un filigrane est visible au milieu des photos, sera-t-il imprimé sur ma photo papier ? </div> 
		<div class="answer">
		  <span class="start">Evidement non, ce filigrane est présent afin de protéger les droits d'auteurs des photographes.</span>
		</div>
		...
		<div class="answer">
		  <span class="start"></span> Oui ! Notre but est de mettre en relation les particuliers désireux de profiter des services de photographes professionnels et les-dits photographes. Pour cela, rendez vous dans la section <a href=events.php> calendrier </a> et, après avoir vérifier que votre événement ni figure pas déjà, notifiez le au moyen du bouton "Ajouter un événement". Dés lors l'ensemble des photographes sera notifié de la date et du lieu de votre événement. Au moment où l'un d'entre validera sa présence sur cet événement, vous serez notifié par e-mail.
		</div>
		<br/>
	</div>
</div>
