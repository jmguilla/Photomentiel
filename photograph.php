...
<div id="full_content_mid">
	...
	<div id="photographc">
		...
		<div class="answer">
			...
			nous vous recevrons avec plaisir et vous pourrez vous faire une idée précise de ce que vous risqu... (à non vous ne risquez rien c'est vrai !), des gens avec qui vous serez amené à travailler. N'oubliez pas que dans le monde des technologies informatiques et plus particulièrement lorsque celui ci porte le nom de start-up et est ouvert sur Internet, tout peut aller très vite et nous n'oublierons pas que l'aventure a commencé grâce à vous ! Rejoignez nous vite, vous n'avez rien à perdre ! 
		</div>
		...
		<div class="answer">
			...
			Ou bien tout simplement en nous contactant pour nous remettre les photos en mains propres si vous êtes en région PACA !
			<br/>
			<br/>
